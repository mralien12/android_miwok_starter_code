...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvNumber = (TextView) findViewById(R.id.numbers);
        ...
        TextView tvColor = (TextView) findViewById(R.id.colors);
        ...
        TextView tvPhrase = (TextView) findViewById(R.id.phrases);
    ...
    public void openNumerList(View view) {
